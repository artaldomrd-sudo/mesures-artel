...
for (const k of [1, 2, 3]) for (const giro of [1, 2, 3, 4]) {
  try { ctx.__render('facade', { type: 'ducha_facade', categoria: 'cerramiento', alto: 2000, esquinaAfter: k, esquinaGiro: giro, paneles: [
  ...
  catch (e) { fail++; console.error('  ducha esquina k=' + k + ' giro=' + giro + ':', e.message); }
}
  ...
  try {
    ctx.__render(id, {
      ...
      cols: [
        ...
        { w: 2400, rows: [{ h: 2400, celda: 'gal2_lat', alu: 'P92', gal_pocket: 'der', gal_install: 'fuera', gal_sheetrock: 'no', mosquitera: 'con' }] },
        { w: 3000, rows: [{ h: 2400, celda: 'gal6_3v', alu: 'E200', mosquitera: 'con' }] },
        { w: 900, rows: [{ h: 2400, celda: 'gal1', alu: 'P92' }] },
        { w: 2000, rows: [{ h: 2400, celda: 'gal4_2v', alu: 'P92', gal_install: 'fuera' }] },
      ],
