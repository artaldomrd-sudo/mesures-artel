...
export const PAGINAS = [
    ...
    { id: "calculador-precio-venta.html", titulo: "Calculador de precio de venta", grupo: "cotizaciones", roles: ["cotizaciones"], desc: "Precio de venta por producto según medidas. Tela de mosquitera: ancho × alto → precio (rollo, desperdicio, precio por m² y mínimo por pieza definidos por gerencia, guardados en calculadores/telaMosquitera)." },
